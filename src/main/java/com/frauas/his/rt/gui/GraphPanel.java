...
/**
 * @author Rodrigo
 * https://gist.github.com/roooodcastro/6325153#file-graphpanel-L2
 */
...
//    }
    ...
    public void setScores(java.util.List<Double> scores) {
        this.scores = scores;
        invalidate();
        this.repaint();
    }
    ...
    public JPanel createAndShowGui(java.util.List<Double> scores){
